...
2. **リポジトリの設定を変更**
    1. Projectsの作成
        [make projects](https://github.com/streamwest-1629/terraform-shared/projects/new) から`issue and improve`プロジェクトを作成します．Templateは `Automated kanban` が良いかと思います（楽なので）．
    2. [Settings](https://github.com/streamwest-1629/terraform-shared/projects/settings) の `Pull Requests` から `Automatically delete head branches` の項目にチェックをつけてください．
...
[@issue_and_improve]:https://github.com/streamwest-1629/terraform-shared/projects/1 
